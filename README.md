...
### ✎ แก้ไขได้ทุกเล่ม (เวอร์ชัน Apps Script)
ต่างจาก demo (ที่แก้ได้เฉพาะเล่มที่เพิ่มเอง) — เวอร์ชัน Apps Script กด **✎** แก้ไขได้ **ทุกเล่ม** รวมถึง 195 เล่มเดิม
เช่น เปลี่ยนสถานะ *อยากอ่าน / กำลังอ่าน / ยังไม่เริ่ม → อ่านจบแล้ว* พร้อมให้คะแนนและวันที่ แล้ว **บันทึกกลับลง Google Sheet ทันที** (`updateBook` เขียนเฉพาะคอลัมน์ A–F ของแถวนั้น)
> ไม่มีปุ่ม *ลบ* ในเวอร์ชัน Apps Script โดยตั้งใจ — เพราะแถวหนังสือ 13 แถวแรกใช้ร่วมกับ "ตารางสถิติ" (คอลัมน์ H–N) การลบทั้งแถวจะทำให้สถิติในชีตเพี้ยน (ถ้าต้องลบจริง ให้ลบแถวในชีตเอง)
